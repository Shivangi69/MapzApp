...
import GooglePlaces
import SimpleToast
struct FFUpdatepartyDetails: View {
    ...
    @State private var DairyDes : String?
    @State private var textStyle = UIFont.TextStyle.body
    var arrImage = ["1", "2", "3", "4"]
    @ObservedObject var obs = FFpartyinfoObserver()
                            ...
                            VStack {
                                ...
                                self.gridViewall(geometry)
                                    ...
                                    .fullScreenCover(isPresented: $shownextr, content: {
                                        ...
                                        FeventDetail(filelist : obs.filelistall , addrs : person.Addrs)
                                    })
                            }
//                                .padding(.horizontal, 10.0)
...
//
//                                            } .onTapGesture {                                                obs.showvideopopup1 = false
//
//                                                showCameraPopUp = false
//                                                   showVideoPopUp = false
//                                             //      showrecdPopUp = false
...
//                    }
       ...
       // Spacer()
            ...
            if $showdocPopUp.wrappedValue {
                    ...
                    .offset(x: 100)
                        ...
                        ZStack(alignment: .topLeading) {
                                        TextEditor(text: Binding($Note, replacingNilWith: ""))
                                            .frame(width: UIScreen.main.bounds.width-100, height: 180, alignment: .leading)
                ...
                .frame(width: UIScreen.main.bounds.width-60, height: 410)
                .cornerRadius(20)
                .shadow(color: .gray, radius: 3, x: 1, y: 1)
            }
                      ...
                      //  .background((Color("themecolor")))
                        ...
                        ZStack(alignment: .topLeading) {
                                        TextEditor(text: Binding($DairyDes, replacingNilWith: ""))
                                            .frame(width: UIScreen.main.bounds.width-30, height: 200, alignment: .leading)
...
//  }
//}
struct FFUpdatepartyDetails_Previews: PreviewProvider {
    static var previews: some View {
        FFUpdatepartyDetails()
    }
}

class FFpartyinfoObserver: ObservableObject {
